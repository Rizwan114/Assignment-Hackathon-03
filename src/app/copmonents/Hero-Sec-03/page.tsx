...
function HeroSec() {
  return (
    <div className='w-[1440px] h-[744px] bg-white'>
      ...
      <h1 className='w-[330px] h-[45px] mt-[64px] ml-[80px] font-normal size-[32px] leading-[44.8px] text-[#2A254B] text-3xl'>Our popular products</h1>

        <div className='flex gap-12'>

              {/* picture 01 */}
          <div className='w-[630px] h-[462px] mt-[134px] ml-[80px] gap-[24px]'>
          ...
          <div className='w-[305px] h-[462px] mt-[134px] gap-[24px]'>
            <Image src={"/Chair-2.svg"} alt='Chair' width={305} height={375}></Image>
            <div className='w-209px] h-[63px] gap-[8px]'>
