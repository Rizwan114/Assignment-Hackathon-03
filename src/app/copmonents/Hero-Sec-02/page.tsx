...
export default function Hero() {
  return (
    <div className='w-[1440px] h-[761px] bg-white'>
        ...
        <h1 className='w-[217px] h-[39px] mt-[80px] ml-[80px] font-normal size-[32px] leading-[39.36px] text-[#2A254B] text-3xl'>New ceramics</h1>
        


    <div className='flex'>
                                    {/* pictue 01 */}
        <div className='w-[305px] h-[462px] mt-[52px] ml-[80px] gap-[24px] '>
